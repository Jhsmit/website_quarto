...
The publications page is generated by a python script based on bibliographical data as .json and additional metadata (links to code or data) in a .yaml file. 

To update or create the publications data:

 - Export publications as "CSL JSON" to "Exported Items.json" or update the existing file. 
 - If applicable, update links to code or data in "publications_metadata.yaml"
 - Preview the result by running `quarto preview publications\index.qmd`
